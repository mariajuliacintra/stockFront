...
  
  // CORREÇÃO 1: Removida a declaração redundante/duplicada do estado 'loading'
  
  const [user, setUser] = useState({ email: "", password: "" });
  const [mostrarSenha, setMostrarSenha] = useState(false);
  
  // CORREÇÃO 2: Mantida APENAS a declaração correta do estado 'loading'
...
  // O useEffect está correto: é executado apenas na montagem
  useEffect(() => {
...
    }
  }, []); // Dependência vazia, executa apenas no montagem
